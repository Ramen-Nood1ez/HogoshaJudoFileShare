...
<?php
	...
	function init() {
		...
		echo "<p style='position: absolute; top: 0; right: 14vw;'>Logged in as: " . $_SESSION["username"] . "</p>";
		echo "<a href='logout.php' style='position: absolute; top: 0; right: 0;'>Logout</a> <br>";
	}
